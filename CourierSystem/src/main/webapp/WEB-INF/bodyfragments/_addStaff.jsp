		...
		<div class="card shadow ">
			<div class="card-body ">
				<h5 class="card-title text-center">
					<i class="	fa fa-user-plus" style="font-size: 50px;"></i><br>Add Staff
				</h5>
				<sf:form method="post"
					action="${pageContext.request.contextPath}/home/login/staff"
					modelAttribute="form">
					<br />
					<sf:hidden path="id"/>
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<sf:select class="form-control" name="bId" path="${status.expression}">
								<c:if test="${staffId > 0}">
								<c:out value=""></c:out>
									<sf:option value="${bId}" label="${branch }" ></sf:option>	
																</c:if>
